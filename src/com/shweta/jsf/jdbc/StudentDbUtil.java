...
public class StudentDbUtil {
	...
	public List<Student> getStudents() throws Exception {
		...
		try {
			...
			while (myRs.next()) {
				...
				Student tempStudent = new Student(id, firstName, lastName,age,gender,
						email,address);
	...
	public void addStudent(Student theStudent) throws Exception {
		...
		try {
			...
			String sql = "insert into student (first_name, last_name, age, gender, email, address) values (?, ?, ?, ?, ?, ?)";
			...
			myStmt.setString(3, theStudent.getAge());
	...
	public Student getStudent(int studentId) throws Exception {
		...
		try {
			...
			if (myRs.next()) {
				...
				theStudent = new Student(id, firstName, lastName,age,gender,
						email,address);
			}
			else {
	...
	public void updateStudent(Student theStudent) throws Exception {
		...
		try {
			...
			String sql = "update student "
						+ " set first_name=?, last_name=?, age=?, gender=?, email=?,address=?"
						+ " where id=?";
